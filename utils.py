...
def label_transformer(y_train, y_val) -> pd.Series:
    '''Transform labels to logged vals.'''
...
def model_fit(X_train, y_train_logged) -> LinearRegression():
    '''Return fitted Linear Regression (transformed labels).'''
